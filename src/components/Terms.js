            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-uppercase">Terms & Conditions</h2>
                        <p>Chocolate Monkeys is a collection of digital artworks (NFTs) running on the Ethereum network. This website is only an interface allowing participants to exchange digital collectibles. Users are entirely responsible for the safety and management of their own private Ethereum wallets and validating all transactions and contracts generated by this website before approval. Furthermore, as the Chocolate Monkeys smart contract runs on the Ethereum network, there is no ability to undo, reverse, or restore any transactions.</p>

                        <h6 className="text-uppercase">1. OWNERSHIP</h6>
                        ...
                        <p>B. Personal Use. Subject to your continued compliance with these Terms, Chocolate Monkey Candy Shop LLC grants you a worldwide, royalty-free license to use, copy, and display the purchased Art, along with any extensions that you choose to create or use, solely forthe following purposes: (i) for your own personal, non-commercial use; (ii) as part of a marketplace that permits the purchase and sale of your Chocolate Monkey / NFT, provided that the marketplace cryptographically verifies each Chocolate Monkeys owner’s rights to display the Art for their Chocolate Monkey to ensure that only the actual owner can display the Art; or (iii) as part of a third party website or application that permits the inclusion, involvement, or participation of your Chocolate Monkey, provided that the website/application cryptographically verifies each Bored Ape owner’s rights to display the Art for their Chocolate Monkey to ensure that only the actual owner can display the Art, and provided that the Art is no longer visible once the owner of the Chocolate Monkeys leaves the website/application.
                        </p>

                        <p>C. Commercial Use. Subject to your continued compliance with these Terms, Chocolate
                        ...
                        <p>
                            D. Chocolate Monkeys IP. Other than the rights to the Art, nothing herein gives you any rights
                        ...
                        <p>
                            E. Feedback. You may choose to submit comments, bug reports, ideas or other feedback about
                        ...
                        <h6 className="text-uppercase">2. Your Responsibilities:</h6>
                        ...
                        <h6 className="text-uppercase">3. Fees and Payment</h6>

                        <p>
                            A. If you elect to purchase a Chocolate Monkeys through the Site, any financial transactions that
                        ...
                        <h6 className="text-uppercase">4. Disclaimers</h6>
                        <p>
                        ...
                        <h6 className="text-uppercase">5. Limitation of Liability</h6>
                        ...
                        <h6 className="text-uppercase">6. Risk Assumption</h6>

                        <p>
                            You accept and acknowledge each of the following:
                        </p>
                        <p>
                            A. To the extent that you sell your Chocolate Monkeys NFT, please be aware that the prices of
                        ...
                        <p>
                            B. Ownership of a Chocolate Monkeys confers ownership of digital artwork only. Accordingly,
                        ...
                        <h6 className="text-uppercase">7. Indemnification</h6>
                        <p>
                            You agree to hold harmless and indemnify Chocolate Monkeys and its subsidiaries, affiliates,
                        ...
                        <h6 className="text-uppercase">8. Changes to the Terms and Conditions</h6>
                        <p>
                        ...
                        <h6 className="text-uppercase">9. Children</h6>
                        <p>
                            Our Site is not intended for children. You must be at least 18 years old to access this Site or
                        ...
                        <h6 className="text-uppercase">10. Dispute Resolution; Arbitration</h6>
                        <p>
